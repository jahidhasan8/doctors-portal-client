...
const Services = () => {
    ...
    return (
        <div className='mt-16'>
            ...
            <div className="hero text-slate-600  mt-24 mx-auto">
                <div className="hero-content flex-col  lg:flex-row p-0">
                    <img src={treatment} className="rounded-lg shadow-2xl hidden md:block md:w-[400px]" alt='' />
                    <div className="md:w-[400px] px-6">
